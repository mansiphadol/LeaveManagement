    ...
    <div class="login-container">
        <div class="row">
            <div class="login-form-1">
                <h3>LEAVE DETAILS FORM</h3> 

                <form action="LeaveTemplate.jsp" id="myform" method="post"> 
<!--                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Select Leave Subject:</label>
                        <input list="Leave_type" class="form-control" placeholder="Leave_type" name="Leave_type" />
                        <datalist id="Leave_type">
                             <option value="Medical">Medical</option>
                             <option value="Casual"> Casual</option>
                             <option value="Maternity">Maternity</option>
                              <option value="Vacation">Vacation</option>
                               <option value="OD">Outdoor Duty</option>
                        </datalist>
                      ...
                      <div class="form-group">
                        ...
                        <input list="Leave_type" class="form-control" placeholder="OD subject" name="od_sub" />
                        <datalist id="Leave_type">
                             <option value="Medical">Testing</option>
                             <option value="Casual"> Election duty</option>
                             <option value="Maternity">Consultancy</option>
                              <option value="Vacation">Industrial Visit</option>
                               <option value="OD">School Duty</option>
                        </datalist>

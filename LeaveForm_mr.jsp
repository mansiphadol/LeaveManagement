    ...
    <div class="login-container">
        <div class="row">
            <div class="login-form-1">
                ...
                <form action="LeaveTemplate_mr.jsp" name="lform" method="post" accept-charset="utf-8"> 
                    ...
                    <div class="form-group">
                        ...
                        <!--<input list="to_whom" name="to_whom" placeholder="प्रति" class="form-control" required>-->
<!--                        <datalist id="to_whom">
                    ...
                    <div class="form-group">
                        <label>रजेचा विषय निवडा</label><br>
<!--                        <input list="leave_type" class="form-control" placeholder="रजेचा विषय निवडा" name="leave_type" />
                        <datalist id="leave_type">
                            <option value="Medical">वैद्यकीय रजा</option>
                            <option value="Casual">प्रासंगिक रजा</option>
                            <option value="Maternity">प्रसूती रजा</option>
                        </datalist>-->
                        <select name="leave_type" style="width: 100%; padding: 7px 1vw; border:none">
                            <option value="Medical">वैद्यकीय रजा</option>
                            <option value="Casual"> प्रासंगिक रजा</option>
                            <option value="Maternity">प्रसूती रजा</option>
                        </select>

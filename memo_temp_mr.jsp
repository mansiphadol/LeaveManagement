...
//                   String dept=request.getParameter("memo_dept");
//                   session.setAttribute("mdept", dept);
                   
                   session.setAttribute("msub",request.getParameter("memo_sub"));
                   session.setAttribute("mdept",request.getParameter("memo_dep"));
    ...
    <body id="body1">
        ...
        <table id="printThis">
            <center>  <div id="img1" > <img  src="https://gpnashik.ac.in/new-site/images/logo.png" /></div>
               <h1>  <mark> <strong>निवेदन पत्र </strong>  </mark></h1>
            </center>
<!--        <table id="printThis">-->
            <tr id="printThis">
                <td id="date">
...
<!--                   // Government Polytechnic Nashik -->
             ...
             <tr id="printThis">
                <td><br>
                    <strong>विषय:</strong> अधिक ${msub} रजा घेण्याबद्दल .
            ...
            <tr>
                <td id="content1" style="text-align: justify;"><br>
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        ...
                        नमस्कार, माझे नाव, <strong>${rname} </strong> आहे. मी माझ्या पदाचा राजीनामा देत असल्याची माहिती देण्यासाठी  हे पत्र लिहित आहे. मी <strong>    ${dept} </strong>विभागात <strong>${rdesig} </strong>आहे .

...
//            str = URLDecoder.decode(request.getParameter("user_name"), "UTF-8");
          ...
          //  out.print(session.getAttribute("uname"));
            session.setAttribute("odleavetype", request.getParameter("odleave_type"));
...
//            String res = URLDecoder.decode(request.getParameter("reason"), "UTF-8");
            ...
            session.setAttribute("odtowhom",request.getParameter("to_whom"));
...
<!--                    to-->
             ...
             <tr>
                <td><br>
                    <strong> विषय:</strong> ${odleavetype} करीता रजा मागणारे पत्र .

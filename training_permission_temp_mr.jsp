...
<!--                    gpn-->
             ...
             <tr>
                <td><br>
                    <strong> विषय:</strong>प्रशिक्षण परवानगी घेण्याबाबतचे पत्र.
                ...
                <td id="content1" style='text-align: justify'><br>
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        ...
                        नमस्कार, माझे नाव <strong>
                            ${uname}</strong> आहे , मी <strong name="part">${dep}</strong> या शाखेत <strong>${desig}</strong> आहे . मला<strong>  ${reason}</strong>, दिनांक<strong> ${bdate}</strong> ते <strong> ${edate} </strong>प्रशिक्षण रजा हवी आहे .माझे प्रशिक्षण केंद्र  ${place} आहे. माझे मत स्पष्ट करण्यासाठी मी संदर्भ देखील जोडला आहे .

...
<html>
    ...
    <body id="body1">
        ...
        <center>
            ...
            <form action="Apply" method="post" style="margin-left: 50px; margin-top: 10px;">
...
<!--            <input type="submit" id='apply' style="font-size:22px;" value="Apply For Leave">-->
    ...
    <jsp:scriptlet> 
        ...
        ltype = request.getParameter("Leave_type");
...
<!--        <table id="printThis">-->
            ...
            <tr id="printThis">
                <td id="to">
                    <strong>    To,</strong><br>
                <jsp:expression> to </jsp:expression>, <br>
                ${empdept},
            ...
            <tr id="printThis">
             ...
             <tr id="printThis">
                <td><br>
                    ...
                    <jsp:expression> ltype</jsp:expression> leave
                </td>
            </tr>
             <tr>
                <td><br>
            ...
            <tr>
             ...
             <strong> ${empdept} department&nbsp;</strong>of <strong>&nbsp;Government Polytechnic Nashik</strong> is writing you  letter, to request you for a<strong> <jsp:expression> ltype </jsp:expression></strong> leave
             ...
             %>
             </strong> because of following reasons: &nbsp;<b><jsp:expression> lreason </jsp:expression> </b>
